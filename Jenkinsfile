...
node ('slave-1') { // slave-1 pulls code from master
    sh 'cd /home/ubuntu20'
    sh 'rsync -aP --delete -e "ssh -i /home/ubuntu20/.ssh/bonavadeur" filvr@192.168.101.117:/home/filvr/bonavadeur/jenkins/workspace/jenkins-php-pipeline/ ./jenkins/workspace/jenkins-php-pipeline/'
}
