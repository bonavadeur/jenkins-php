...
node ('slave-1') { // slave-1 pulls code from master
    sh 'cd /home/ubuntu20'
    sh 'rsync -aP --delete -e "ssh -i ./.ssh/bonavadeur" filvr@192.168.101.117:~/bonavadeur/jenkins/workspace/jenkins-php-pipeline/ ./jenkins/workspace/jenkins-php-pipeline/'
}
